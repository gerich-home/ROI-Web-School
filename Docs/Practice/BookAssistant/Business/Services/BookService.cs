...
namespace BookAssistant.Bussines.Services
{
    public class BookService
    {
        private static readonly List<Book> Books = new List<Book>
        {
            ...
            {
                Id = 0,
                Title = "Блабла. Улучшение существующего кода",
                ...
                Img="1.jpg",
                News = "Блабла. Улучшение существующего кода"
            },
            new Book
            {
                Id = 1,
                ...
                Description = "Мартин Фаулер с соавторами пролили свет на процесс рефакторинга, описав принципы и лучшие приемы его осуществления, а также указав, где и когда следует начинать углубленное изучение кода с целью его улучшения.",
                Img="1.jpg",
                News = "Рефакторинг. Улучшение существующего кода"
            },
            new Book
            {
                Id = 2,
                ...
                Img="2.jpg",
                News = "Шаблоны тестирования xUnit"
            },
            new Book
            {
                Id = 3,
                ...
                Img="3.jpg",
                News = "Рефакторинг баз данных. Эволюционное проектирование"
            },
            new Book
            {
                Id = 4,
                ...
                Img="4.jpg",
                News = "Шаблоны реализации корпоративных приложений"
            }
        };
